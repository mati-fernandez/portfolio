...
d.addEventListener('DOMContentLoaded', (e) => {
  ...
  const quotesEng = [
    ...
    'Duality, which rules this world, is a Matrix strategy to harvest our energy. Every time it manages to confront us each other it gets its fuel. Or every time there is tension of any kind between beings.',
    'With the manipulation of language they manage the masses. Selling your soul is not necessarily that. It means selling your avatar, they partially or totally limit the connection with your self outside the simulation and therefore have more control over it than you.',
    'Religions are one of the many stories that are imposed on us from childhood to manipulate us. They take advantage of the human need to believe in something higher or, perhaps, the suspicion that something higher exists. But it is necessary that you do not know what the true nature of this world is, that you continue to believe in the game, that you remain immersed.',
    "The Matrix will always try to trap your mind and destabilize you away from the truth. Stay mentally focused, don't let it shake your being and harvest your energy. Each individual who comes close to the truth is a threat to the world that contains him. At some point you will notice very strange situations because you will no longer fall into common traps, and it will manage to steal your energy in very strange ways (this can help you realize in some of them that this comes from above, or rather, from outside the limits of your perception).",
    "Everything in principle is mind. If attacks do not pass the mind's filter, your physical and/or emotional body is less likely to be affected. Don't let the Matrix use you to create realities that don't suit you.",
    "The children's movie of the monsters that harvest energy in this plane is also negative priming.",
    'The issue with negative priming is understanding that they mix truth with lies and knowing what to stick with.',
    "Don't let your defenses activate because you believe I'm a flat earther, don't be an NPC, I never talked about flat earthing. I think it is one more issue that they impose to divide and distract us.",
    "I'm not interested in you agreeing with me. I just try to understand a little more every day. Don't we all want the same thing? Be a little better every day?",
  ...
  const quotesEsp = [
    ...
    'La dualidad, que rige este mundo, es una estrategia de Matrix para cosechar nuestra energía. Cada vez que logra enfrentarnos obtiene su combustible. O cada vez que logra tensión de cualquier tipo entre seres.',
    'Con la manipulación del lenguaje manejan a las masas. Vender tu alma no es necesariamente eso. Significa vender tu avatar, limitan parcial o totalmente la conexión contigo mismo fuera de la simulación y por tanto tienen más control sobre él que tú.',
    'Las religiones son uno de los tantos cuentos que nos imponen desde pequeños para manipularnos. Se aprovechan de la necesidad del ser humano de creer en algo superior o, quizas en la sospecha de que hay algo superior. Pero necesita que no sepas cual es la verdadera naturaleza de este mundo, que sigas creyendo en el juego, que te mantengas inmerso.',
    'Matrix siempre intentará atrapar tu mente y desestabilizarte para alejarte de la verdad. Mantente mentalmente enfocado, no dejes que eso sacuda tu ser y coseche tu energía. Cada individuo que se acerca a la verdad es una amenaza para el mundo que lo contiene. En algún momento notarás situaciones muy extrañas porque ya no caerás en trampas comunes, y logrará robarte tu energía de maneras muy extrañas (esto puede ayudarte a darte cuenta en algunas de ellas que esto viene de arriba, o mejor dicho, desde fuera de los límites de tu percepción).',
    'Todo en principio es mente. Si los ataques no pasan el filtro de la mente, es menos probable que tu cuerpo físico y/o emocional se vea afectado. No dejes que Matrix te utilice para crear realidades que no te convienen.',
    'La película infantil sobre los monstruos que recolectan energía en este plano también es primado negativo.',
    'El tema del primado negativo es entender que mezclan verdad con mentira y saber con qué quedarse',
    'Que no se te activen tus defensas por creer que soy terraplanista, no seas NPC, yo nunca hablé de terraplanismo. Creo que es un tema mas que imponen para dividirnos y distraernos.',
    'No me interesa que me des la razón. Solo trato de entender cada día un poco más. Acaso no queremos todos lo mismo? Estar cada día un poco mejor?',
